...
//                   <input type="text" className="input-newsletter" placeholder="Your Email" name="EMAIL" required />
//                   <button type="submit">
...
//             <p>
//               Copyright &copy; {currentYear} <strong>Texap</strong>. All Rights Reserved by{' '}
